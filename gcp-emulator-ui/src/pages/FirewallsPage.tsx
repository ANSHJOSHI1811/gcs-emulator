...
const FirewallsPage = () => {
  ...
  const loadData = async () => {
    try {
      ...
      // Load firewalls
      const firewallsRes = await apiClient.get('/compute/v1/projects/demo-project/global/firewalls');
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiClient.post('/compute/v1/projects/demo-project/global/firewalls', ruleData);
  ...
  const handleDelete = async (firewallName: string) => {
    ...
    try {
      await apiClient.delete(`/compute/v1/projects/demo-project/global/firewalls/${firewallName}`);
      await loadData();
    } catch (error: any) {
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="px-6 py-4 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">Create Firewall Rule</h2>
            </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                  />
                  <p className="mt-1 text-xs text-gray-500">0-65535 (lower = higher priority)</p>
                </div>
                ...
                <div className="col-span-2">
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    Comma-separated ports or ranges (e.g., 80,443,8080-8090). Leave empty for all ports.
                  </p>
                </div>
                ...
                <div className="col-span-2">
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    Comma-separated tags. Leave empty to apply to all instances.
                  </p>
                </div>
              </div>
