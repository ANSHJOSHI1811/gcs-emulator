...
def list_subnetworks(project_id: str, region: str = None):
    ...
    try:
        ...
        response = {
            ...
            "id": f"projects/{project_id}/regions/{region}/subnetworks" if region else f"projects/{project_id}/aggregated/subnetworks",
            "items": items,
            "selfLink": f"{base_url}/compute/v1/projects/{project_id}/regions/{region}/subnetworks" if region else f"{base_url}/compute/v1/projects/{project_id}/aggregated/subnetworks"
        }
